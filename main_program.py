...
getCombinedData("MCD","2020-12-09","trainMCD_new.txt","MCD.train")
getCombinedData("MCD","2020-12-09","testMCD_new.txt","MCD.test")
getimdb("MCD","2020-12-09","trainMCD_new.txt","imdb.train")
getimdb("MCD","2020-12-09","testMCD_new.txt","imdb.test")
